...
public class HttpClientPoolUtils {
    ...
    private static SSLConnectionSocketFactory createSSLConnSocketFactory() {
        ...
        try {
            ...
            System.out.println("创建SSL连接工厂错误："+e);
        }
        return sslsf;
    }
    ...
    public static String sendGet(String url) {
        ...
        try {
            ...
            System.out.println("HttpClient.GET exception "+ e);
        } finally {
            try {
                if (null != response) {
                    response.close();
                ...
                System.out.println("CloseableHttpResponse exception "+e);
            }
        }
        return body;
    }
    ...
    public static String sendPostWithFile(String url, Map<String, MultipartFile> fileParams, Map<String, String> otherParams, Map<String, String> headerParams) {
        ...
        try {
            ...
            System.out.println("执行post请求出错：sendPostWithFile");
        } finally {
            try {
                if (null != response) {
                    response.close();
                ...
                System.out.println("关闭CloseableHttpResponse出错"+ e);
            }
        }
        return body;
    }
    ...
    public static String sendPostJson(String postUrl, String jsonStr,String token) {
        ...
        try {
            ...
            System.out.println("请求HttpClient.POSTJSON出错"+e);
        } finally {
            try {
                if (null != response) {
                    response.close();
    ...
    public static CloseableHttpClient getHttpClientCore() {
        try {
            ...
            System.out.println("获取httpclient失败，错误堆栈原因；" + e.getMessage());
        }
        return httpClient;
    }
